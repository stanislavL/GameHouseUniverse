...
//  GameHouseUniverse
//
//  Created by stanislav on 20/10/14.
...
- (CGSize)swipeViewItemSize:(__unused GHUSwipeView *)swipeView { return CGSizeZero; }
- (void)swipeViewDidScroll:(__unused GHUSwipeView *)swipeView {}
- (void)swipeViewCurrentItemIndexDidChange:(__unused GHUSwipeView *)swipeView {}
- (void)swipeViewWillBeginDragging:(__unused GHUSwipeView *)swipeView {}
- (void)swipeViewDidEndDragging:(__unused GHUSwipeView *)swipeView willDecelerate:(__unused BOOL)decelerate {}
- (void)swipeViewWillBeginDecelerating:(__unused GHUSwipeView *)swipeView {}
- (void)swipeViewDidEndDecelerating:(__unused GHUSwipeView *)swipeView {}
- (void)swipeViewDidEndScrollingAnimation:(__unused GHUSwipeView *)swipeView {}
- (BOOL)swipeView:(__unused GHUSwipeView *)swipeView shouldSelectItemAtIndex:(__unused NSInteger)index { return YES; }
- (void)swipeView:(__unused GHUSwipeView *)swipeView didSelectItemAtIndex:(__unused NSInteger)index {}

@end


@interface GHUSwipeView () <UIScrollViewDelegate, UIGestureRecognizerDelegate>
...
- (void)setDataSource:(id<GHUSwipeViewDataSource>)dataSource
{
...
- (void)setDelegate:(id<GHUSwipeViewDelegate>)delegate
{
...
- (void)setAlignment:(GHUSwipeViewAlignment)alignment
{
...
- (void)updateScrollViewDimensions
{
    ...
    switch (_alignment)
    {
        case GHUSwipeViewAlignmentCenter:
        {
            if (_vertical)
            {
        ...
        case GHUSwipeViewAlignmentEdge:
        {
            if (_vertical)
            {
...
- (CGFloat)offsetForItemAtIndex:(NSInteger)index
{
    ...
    if (_wrapEnabled)
    {
        if (_alignment == GHUSwipeViewAlignmentCenter)
        {
...
- (void)setScrollOffset:(CGFloat)scrollOffset
{
    if (fabsf(_scrollOffset - scrollOffset) > 0.0001f)
    {
        ...
        [self updateScrollViewDimensions];
        [self updateLayout];
        CGPoint contentOffset = _vertical? CGPointMake(0.0f, [self clampedOffset:scrollOffset] * _itemSize.height):
